...
import { ChampionMastery, DDChampion, LeagueEntries, Match, MatchInformationAdded, MatchList, Summoner } from '@league/api-interfaces';
...
const reducer = createReducer(
  ...
  on(
    riotActions.fetchedSummoner,
    (state: IRiot, { summoner }): IRiot => ({
      ...state,
      summoner: {
        isLoading: false,
        data: summoner,
  ...
  on(
    riotActions.fetchChampionMasteries,
    (state: IRiot): IRiot => ({
      ...state,
      championMasteries: {
  ...
  on(
    ...
    (state: IRiot, { championMastery }): IRiot => ({
      ...state,
      championMasteries: {
  ...
  on(
    ...
    (state: IRiot, { matchInformation }): IRiot => ({
      ...state,
      matchList: {
        ...state.matchList,
        data: {
