...
import { QueueInformation } from '@league/api-interfaces';
...
export class QueueName {
  ...
  public queueName(queueId: number): QueueInformation {
    return {
      // @ts-ignore
      queueDescription: this.ob.find((o) => o.queueId === queueId).description,
      // @ts-ignore
      queueMap: this.ob.find((o) => o.queueId === queueId).map,
    };
  }
}
